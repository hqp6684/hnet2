...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MedicalInformation.primary_doc'
        db.alter_column(u'medicalinfo_medicalinformation', 'primary_doc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Doctor'], null=True))

    def backwards(self, orm):

        # Changing field 'MedicalInformation.primary_doc'
        db.alter_column(u'medicalinfo_medicalinformation', 'primary_doc_id', self.gf('django.db.models.fields.related.ForeignKey')(default='admin', to=orm['users.Doctor']))
    ...
    models = {
        ...
        u'medicalinfo.medicalinformation': {
            ...
            'problem': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        u'users.doctor': {
