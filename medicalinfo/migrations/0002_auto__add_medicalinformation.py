...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'medicalinfo_medicalinformation', (
            ...
            ('primary_doc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Doctor'])),
            ('problem', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
    ...
    models = {
        ...
        u'medicalinfo.medicalinformation': {
            ...
            'primary_doc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Doctor']"}),
