...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MedicalInformation.initialized'
        db.add_column(u'medicalinfo_medicalinformation', 'initialized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MedicalInformation.initialized'
        db.delete_column(u'medicalinfo_medicalinformation', 'initialized')
