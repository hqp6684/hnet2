...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.ref_if'
        db.delete_column(u'users_userprofile', 'ref_if')

        # Adding field 'UserProfile.ref_id'
        db.add_column(u'users_userprofile', 'ref_id',
                      self.gf('django.db.models.fields.CharField')(default='abc', unique=True, max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.ref_if'
        db.add_column(u'users_userprofile', 'ref_if',
                      self.gf('django.db.models.fields.CharField')(default='abc', max_length=120, unique=True),
                      keep_default=False)

        # Deleting field 'UserProfile.ref_id'
        db.delete_column(u'users_userprofile', 'ref_id')
