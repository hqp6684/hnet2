...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'sSN', self.gf('localflavor.us.models.USSocialSecurityNumberField')(default=datetime.datetime(2015, 3, 29, 0, 0), unique=True, max_length=11))

    def backwards(self, orm):

        # Changing field 'UserProfile.sSN'
        db.alter_column(u'users_userprofile', 'sSN', self.gf('localflavor.us.models.USSocialSecurityNumberField')(unique=True, max_length=11, null=True))
