...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserProfile', fields ['ref_if']
        db.create_unique(u'users_userprofile', ['ref_if'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['ref_if']
        db.delete_unique(u'users_userprofile', ['ref_if'])
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'ref_if': ('django.db.models.fields.CharField', [], {'default': "'abc'", 'unique': 'True', 'max_length': '120'}),
