...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'sSN', self.gf('localflavor.us.models.USSocialSecurityNumberField')(max_length=11, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.sSN'
        db.alter_column(u'users_userprofile', 'sSN', self.gf('localflavor.us.models.USSocialSecurityNumberField')(default='', max_length=11, unique=True))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'sSN': ('localflavor.us.models.USSocialSecurityNumberField', [], {'max_length': '11', 'unique': 'True', 'null': 'True'}),
