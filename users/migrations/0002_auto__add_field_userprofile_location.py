...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_userprofile', 'location',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'users_userprofile', 'location')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'location': ('django.db.models.fields.CharField', [], {'default': "'01'", 'max_length': '2'}),
